...
#Exercício 9.25 Altere as funções pede_noflle e pede_ telefone de forma a receberem um
#parâmetro opcional. Caso esse parâmetro seja passado, utilize-o como retorno caso
#a entrada de dados seja vazia.
