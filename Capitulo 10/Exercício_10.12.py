...
#Exercício 10.12 Observe o método saque das classes Conta e ContaEspeci.a l. Modifique o método saque da classe Conta de forma que a verificação da possibilidade
#de saque seja feita por um novo método, substituindo a condição atual. Esse novo
#método retornará verdadeiro se o saque puder ser efetuado, e falso, caso contrário. Modifique a classe ContaEspeci.al de forma a trabalhar com esse novo método.
#Verifique se você ainda precisa trocar o método saque de ContaEspeci.al ou apena
